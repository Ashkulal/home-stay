  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link to="/" className="text-xl md:text-2xl font-bold text-emerald-600 flex items-center gap-2">
          <span>🏡</span>
          <span>Ibbani Stay</span>
        </Link>
        ...
        <div className={`${open ? "flex" : "hidden"} md:flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-5 text-sm absolute md:static top-14 left-0 right-0 bg-white md:bg-transparent shadow-md md:shadow-none p-4 md:p-0 z-50`}>
          ...
          <Link to="/homestays" className="hover:text-emerald-600 transition-colors font-medium" onClick={() => setOpen(false)}>Stays</Link>
