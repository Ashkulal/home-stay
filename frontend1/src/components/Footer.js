      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold text-white mb-3">🏡 Ibbani Stay</h3>
            <p className="text-sm leading-relaxed">Experience authentic mountain hospitality in Karnataka. Book cozy homestays near breathtaking peaks and create unforgettable memories.</p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              ...
              <Link to="/homestays" className="hover:text-emerald-400 transition-colors">Find Stays</Link>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p>&copy; 2026 Ibbani Stay. All rights reserved.</p>
